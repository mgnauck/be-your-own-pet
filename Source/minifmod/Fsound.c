...
///CHANGE	
			...
			FMUSIC_PlayingSong->time_ms += (((float)SamplesToMix * (float)FSOUND_OOMixRate) * 1000.f);
		}

///CHANGE
		FMUSIC_TimeInfo[FSOUND_Software_FillBlock].ms    = (int)FMUSIC_PlayingSong->time_ms;
